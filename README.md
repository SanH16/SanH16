...
| $\color{#F4F1BB}{\textsf{GIT}}$ | $\color{#F4F1BB}{\textsf{REDUX}}$ | $\color{#F4F1BB}{\textsf{REACT JS}}$ | $\color{#F4F1BB}{\textsf{NODE JS}}$ | $\color{#F4F1BB}{\textsf{WEBPACK}}$ | 
| ------------- | ------------- | ------------- | ------------- | ------------- |
